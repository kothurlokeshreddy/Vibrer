...
const Process = () => {
    return (
      <section className="process-section">
        ...
        <div className="stands-cards-container">
          <div className = "stands-out-card">
            <FaBox style = {{height : '60px', width : '60px', marginTop: '30px'}}/>
            <div className="text-card">
              <h4>500 + Collections</h4>
              <p>Our journey begins with a comprehensive understanding of your unique style and space requirements.</p>
            </div>
          </div>
          <div className = "stands-out-card">
            <GiRolledCloth style = {{height : '60px', width : '60px', marginTop: '30px'}}/>
            <div className="text-card">
              <h4>300 + Fabrics</h4>
              <p>Our journey begins with a comprehensive understanding of your unique style and space requirements.</p>
            </div>
          ...
          <div className = "stands-out-card">
            <BsCheckCircleFill style = {{height : '60px', width : '60px', marginTop: '30px'}}/>
            <div className="text-card">
          ...
          <div className = "stands-out-card">
            <IoIosColorPalette style = {{height : '60px', width : '60px', marginTop: '30px'}}/>
            <div className="text-card">
              <h4>Colour and Length customization</h4>
              <p>Our journey begins with a comprehensive understanding of your unique style and space requirements.</p>
            </div>
          </div>
        </div>
